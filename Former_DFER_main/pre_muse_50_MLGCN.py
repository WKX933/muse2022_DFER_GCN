...
def main():
    ...
    for k in list(state_dict['state_dict']):
        rename = k.replace('module.','')
        state_dict['state_dict'][rename]=state_dict['state_dict'].pop(k)
    ...
    model.module.model.load_state_dict(state_dict['state_dict'], strict=False)
    model.module.model.load_state_dict(state_dict_res50,strict=False)
    model = model.cuda()
    # model = model.module
