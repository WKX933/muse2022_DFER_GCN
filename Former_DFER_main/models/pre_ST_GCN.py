...
from Former_DFER_main.models.S_Former_pre50 import spatial_transformer
from Former_DFER_main.models.T_Former_pre import temporal_transformer
...
class GenerateModel(nn.Module):
    def __init__(self):
        ...
        # self.fc_1 = nn.Sequential(nn.Linear(512, 256), nn.ReLU(True))
