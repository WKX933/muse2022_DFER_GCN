...
class ResNet(nn.Module):   # S-Former after stage3
    ...
    def __init__(self, block, layers, zero_init_residual=False,
        ...
        self.classifier_1 = nn.Conv2d(2048, 256, kernel_size=[1, 1], stride=(1, 1))
        self.fc_trans = nn.Linear(16,49)
    ...
    def forward(self, x):
        ...
        # print('shape5_3:',conv5_3x.shape)
        # pool5_7x7_s1 = self.pool5_7x7_s1(conv5_3x)
        # print('shape_outres50:',pool5_7x7_s1.shape)
        x = self.classifier_1(conv5_2x)
